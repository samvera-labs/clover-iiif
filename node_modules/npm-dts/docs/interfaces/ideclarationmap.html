...
<head>
	...
	<title>IDeclarationMap | npm-dts</title>
	...
	<div class="tsd-page-title">
		<div class="container">
			<ul class="tsd-breadcrumb">
				...
				<li>
					<a href="ideclarationmap.html">IDeclarationMap</a>
				</li>
			</ul>
			<h1>Interface IDeclarationMap</h1>
		</div>
	</div>
</header>
		...
		<div class="col-8 col-content">
			<section class="tsd-panel tsd-comment">
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Map of modules and their declarations</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-hierarchy">
				...
				<ul class="tsd-hierarchy">
					<li>
						<span class="target">IDeclarationMap</span>
					</li>
				</ul>
			</section>
			<section class="tsd-panel tsd-kind-interface">
				<h3 class="tsd-before-signature">Indexable</h3>
				<div class="tsd-signature tsd-kind-icon"><span class="tsd-signature-symbol">[</span>moduleNames: <span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">]: </span><span class="tsd-signature-type">string</span></div>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Map of modules and their declarations</p>
					</div>
			...
			<nav class="tsd-navigation secondary menu-sticky">
				<ul class="before-current">
					...
					<li class=" tsd-kind-interface">
						<a href="convertpathtomoduleoptions.html" class="tsd-kind-icon">Convert<wbr>Path<wbr>ToModule<wbr>Options</a>
					</li>
				</ul>
				<ul class="current">
					<li class="current tsd-kind-interface">
						<a href="ideclarationmap.html" class="tsd-kind-icon">IDeclaration<wbr>Map</a>
					</li>
				</ul>
				<ul class="after-current">
					<li class=" tsd-kind-interface">
						<a href="inpmdtsargs.html" class="tsd-kind-icon">INpm<wbr>Dts<wbr>Args</a>
					</li>
