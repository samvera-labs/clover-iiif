...
| `--clover-font-sans`             | `inherit` | UI and body text; inherits the host page by default |
| `--clover-font-display`          | `inherit` |                                                     |
...
| --------------------------- | ---------------------------------------------- | ---------------------------------------------------------------------------------------------------------------- |
| `--clover-thumbnail-width`  | `161.8px`                                      | Canvas rail tile width, About panel bounding box, and the Slider card when `--clover-slider-item-width` is unset |
...
- **Slider card** — 1:1 from its width, and it prefers `--clover-slider-item-width` when that is set, so cards can be resized without touching the rest.
