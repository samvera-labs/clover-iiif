...
Type in anything in the search field and click search button. This demo will show the search results for "Berliner". Click on any of search results, and Clover will zoom and pan to that search result.
