export const canvasWithPDFs = {
  ...
  items: [
            ...
            items: [
              {
                body: {
                  format: "image/png",
                  height: 1686,
                  id: "http://localhost:3000/media/pdf/file-sample_150kB_pdf_thumbnail.png",
                  type: "Image",
                  width: 1192,
                },
    ...
    // Canvas with standard image with placeholder
    {
      ...
      placeholderCanvas: {
        height: 426,
        id: "https://api.dc.library.northwestern.edu/api/v2/works/71153379-4283-43be-8b0f-4e7e3bfda275?as=iiif/canvas/access/1/placeholder",
        items: [
          {
            id: "https://api.dc.library.northwestern.edu/api/v2/works/71153379-4283-43be-8b0f-4e7e3bfda275?as=iiif/canvas/access/1/placeholder/annotation-page/0",
            items: [
              {
                body: {
                  format: "image/tiff",
                  height: 426,
                  id: "https://iiif.dc.library.northwestern.edu/iiif/2/e549a0f6-e4f4-4629-b6e2-f5c434189705/full/!640,426/0/default.jpg",
                  service: [
                    {
                      "@id":
                        "https://iiif.dc.library.northwestern.edu/iiif/2/e549a0f6-e4f4-4629-b6e2-f5c434189705",
                ...
                id: "https://api.dc.library.northwestern.edu/api/v2/works/71153379-4283-43be-8b0f-4e7e3bfda275?as=iiif/canvas/access/1/placeholder/annotation/0",
                motivation: "painting",
                target:
                  "https://api.dc.library.northwestern.edu/api/v2/works/71153379-4283-43be-8b0f-4e7e3bfda275?as=iiif/canvas/access/1/placeholder",
                type: "Annotation",
              },
            ],
            type: "AnnotationPage",
      ...
      thumbnail: [
        {
          format: "image/jpeg",
          height: 300,
          id: "https://iiif.dc.library.northwestern.edu/iiif/2/e549a0f6-e4f4-4629-b6e2-f5c434189705/full/!300,300/0/default.jpg",
          service: [
            {
              "@id":
                "https://iiif.dc.library.northwestern.edu/iiif/2/e549a0f6-e4f4-4629-b6e2-f5c434189705",
